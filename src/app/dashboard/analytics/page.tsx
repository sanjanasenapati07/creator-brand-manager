...
export default function AnalyticsPage() {
  ...
  const stageColors: Record<string, string> = {
    outreach: 'from-gray-400 to-gray-500',
    negotiation: 'from-yellow-400 to-amber-500',
    active: 'from-blue-400 to-blue-600',
    invoicing: 'from-purple-400 to-purple-600',
              ...
              return (
                <div key={stage} className="flex items-center gap-4">
                  ...
                  <div className="flex-1 bg-gray-100 rounded-full h-3 overflow-hidden">
                    <div
                      className={'h-3 rounded-full bg-gradient-to-r ' + stageColors[stage]}
                      style={{
                        width: pct + '%',
